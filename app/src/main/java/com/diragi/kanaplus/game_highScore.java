...
public class game_highScore extends Activity {
    int[] hiragana;
    ImageView kanaView;
    int currentKana;
    Boolean all = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor.putInt("highHighScore", 0);

        editor.putString("mode", "high");

        all = mPrefs.getBoolean("allCheckBox", false);

        int highScorePref = mPrefs.getInt("highScoreHigh", 0);
    ...
    public void changeImage(){
            ...
            if (score > highScore) {
                ...
                highScoreBox = (TextView)findViewById(R.id.highScore);
                highScoreBox.setText(String.valueOf(highScore));
                editor.putInt("highScoreHigh", highScore);
                editor.commit();
            ...
            if (score > localHighScore) {
                ...
                editor.putInt("highHighScore", localHighScore);
                editor.commit();
            }
            ...
            Log.d("Options.length = ", String.valueOf(options.length));
            ...
            if (options.length == 0) {
                ...
                builder.setNeutralButton("Continue", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent goChoseKana = new Intent(game_highScore.this, Custom.class);
                ...
                if (!offline) {
                    ...
                    try {
                        ...
                        Log.d("Superrandval:", String.valueOf(superRandVal));
    ...
    public void onWrongAnswer(){
        ...
        if (score == 0) {
            ...
            editor.putInt("highScoreHigh", highScore);
            editor.commit();
            Intent gameOver = new Intent(game_highScore.this, gameOverActivity.class);
    ...
    public void checkAnswer(int position, String ans) {
        ...
        if (currentKana == position) {
            ...
            answerBox = (EditText)findViewById(R.id.editTextHighSwag);
            scoreTextView = (TextView)findViewById(R.id.scoreTextView);
